...
DONE 2026-08-13. Extension form functional end-to-end, pushed. @BuildStep fires, ApplicationModel from augmentation (no TASK-9), core Analyzer runs, ArC annotation-consumer signal resolves hibernate-validator on rest-fights (suspect->used-bytecode). 3 unit tests; 93/93 reactor green. DoD: /simplify clean, /code-review 9-point pass all green. 5 commits pushed (d11ecd6..d7d8269).
<!-- SECTION:NOTES:END -->
