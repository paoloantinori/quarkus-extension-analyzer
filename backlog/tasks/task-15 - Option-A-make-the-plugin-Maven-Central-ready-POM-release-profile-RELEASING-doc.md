...
4. docs/RELEASING.md documenting the user-side prerequisites (Sonatype Central namespace for io.github.pantinor, GPG key, settings.xml server) and the release steps.
